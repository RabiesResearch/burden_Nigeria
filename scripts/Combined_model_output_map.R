...
death_map<-ggplot(Rabies_all_varible_Nigeria) +
...
Rabid_map<-ggplot(Rabies_all_varible_Nigeria) +
...
Rabies_all_varible_Nigeria$avg_PEP_use_cat <- cut(
 ...
 PEP_vac_map<- ggplot(Rabies_all_varible_Nigeria) +
...
#plot an incidence map
 ...
 Incidence_map<- ggplot(Incidence_per_100k_Nigeria) +
 ...
 combined <- (death_map |Incidence_map ) / (Rabid_map|PEP_vac_map ) +
 ...
 ggsave("combined_model_output.jpeg", combined, width = 12, height =10)
